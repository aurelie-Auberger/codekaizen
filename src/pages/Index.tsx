...
const faqs = [
  ...
  { q: "Comment fonctionne la tarification ?", r: "Le diagnostic est facturé 500 € HT, déduit si une mission démarre. La construction est facturée à l'acte selon la complexité. Le pilotage est mensuel, sans engagement de durée. Pas de commission sur votre CA, pas de coûts variables : vous savez exactement ce que vous payez et pourquoi." },
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5 md:gap-6">
            {[
              ...
              { t: "On gagne seulement si vous gagnez", d: "Le modèle à la performance n'est pas un argument commercial. C'est une contrainte que nous nous imposons : si le système ne produit pas, nous ne gagnons pas. Cette structure élimine le conflit d'intérêt entre prestataire et client, et aligne chaque action sur une seule métrique : le CA généré." },
