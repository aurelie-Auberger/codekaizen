...
const PhasesTimeline = () => (
  <div style={{padding:'8px 0 24px',fontFamily:'Inter,system-ui,sans-serif'}}>
    ...
    {[
      ...
      {num:'04',timing:"J+21 · jusqu'aux résultats",title:'Campagnes outbound',desc:'Séquences email + LinkedIn, personnalisation niveau 3, A/B testing systématique.',pills:[] as string[]},
